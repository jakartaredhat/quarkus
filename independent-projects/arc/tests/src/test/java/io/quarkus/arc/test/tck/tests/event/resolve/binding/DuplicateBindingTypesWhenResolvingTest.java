...
public class DuplicateBindingTypesWhenResolvingTest extends AbstractTestUtils {
    ...
    public void testDuplicateBindingTypesWhenResolvingFails() {
        assertThrows(IllegalArgumentException.class, this::dotestDuplicateBindingTypesWhenResolvingFails,
                "Did not see IllegalArgumentException");
    }

    private void dotestDuplicateBindingTypesWhenResolvingFails() {
        Set<ObserverMethod<? super AnEventType>> methods = getCurrentManager().resolveObserverMethods(new AnEventType(),
                new BindingTypeABinding("a1"), new BindingTypeABinding("a2"));
