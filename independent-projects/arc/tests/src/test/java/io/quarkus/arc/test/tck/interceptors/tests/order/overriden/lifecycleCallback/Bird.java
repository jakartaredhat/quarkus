...
public class Bird {
    ...
    public void init() {
        ...
        System.out.printf("Bird.postConstruct(%d)\n", initBirdCalled.get());
    }

    @PreDestroy
    public void destroy() {
        destroyBirdCalled.incrementAndGet();
        System.out.printf("Bird.preDestroy(%d)\n", destroyBirdCalled.get());
    }

    public static void reset() {
        initBirdCalled.set(0);
        destroyBirdCalled.set(0);
        System.out.printf("Bird.reset(%d, %d)\n", initBirdCalled.get(), destroyBirdCalled.get());
    }
