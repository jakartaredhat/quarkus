...
public class ParameterizedTypesInjectionToParameterizedWithWildcardTest {
    @RegisterExtension
    public ArcTestContainer container = new ArcTestContainer(Dao.class, IntegerStringDao.class, StringDao.class,
            NumberDao.class,
    ...
    public void testInjection() {
        ParameterizedTypesInjectionToParameterizedWithWildcardTest.InjectContainer bean = Arc.container()
                .instance(ParameterizedTypesInjectionToParameterizedWithWildcardTest.InjectContainer.class).get();
